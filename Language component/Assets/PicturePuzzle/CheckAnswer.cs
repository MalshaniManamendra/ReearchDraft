...
{
    public GameObject letterOne, letterTwo, letterThree, letterFour, letterFive, letterSix, letterSeven, letterEight, BoxOne, BoxTwo, BoxThree;
    ...
    public void Check()
    {
        str = BoxThree.name + BoxTwo.name + BoxOne.name;
